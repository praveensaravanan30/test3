...
2. Compiles and simulates testbenches with iverilog/vvp
3. Analyzes simulation logs for assertion execution
4. Grades testbenches based on assertion coverage

Note: This uses SystemVerilog/iverilog, NOT cocotb.
"""
...
class AssertionChecker:
    ...
    def check_assertions_in_log(self, log_path: Optional[str] = None) -> Dict[str, any]:
        """
...
def grade_generated_testbench(
    ...
    Args:
        ...
        simulator: Simulator to use (default: icarus)
